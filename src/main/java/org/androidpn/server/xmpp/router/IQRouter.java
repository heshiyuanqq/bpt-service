...
import org.androidpn.server.xmpp.handler.IQPingHandler;
...
public class IQRouter {
    ...
    public IQRouter() {
        ...
        iqHandlers.add(new IQPingHandler());
    ...
    private void updateNotification(String id,String userName) throws SQLException{
    	/**
    	NotificationPO notificationMO = notificationService.queryNotificationByUserName(userName, id);
    	if(notificationMO != null){
        	if(NotificationPO.STATUS_RECEIVE.equals(notificationMO.getStatus())){
            	notificationMO.setStatus(NotificationPO.STATUS_READ);
        	}else{
            	notificationMO.setStatus(NotificationPO.STATUS_RECEIVE);
        	}
