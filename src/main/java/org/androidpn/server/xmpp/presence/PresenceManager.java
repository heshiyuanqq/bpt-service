...
public class PresenceManager {
	 ...
	 */
	public boolean isAvailable(AppTokenSession terminal) {
		return sessionManager.getSession(terminal.getXppId()) != null;
	}
	 ...
	 */
	public Presence getPresence(AppTokenSession terminal) {
		if (terminal == null) {
			return null;
		}
		Presence presence = null;
		ClientSession session = sessionManager
				.getSession(terminal.getXppId());
		if (session != null) {
